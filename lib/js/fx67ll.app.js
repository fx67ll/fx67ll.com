...
(function (global) {
	...
	function startTyping(options) {
		...
		var reduceMotion = settings.respectReducedMotion && global.matchMedia &&
	...
	function initSite(options) {
		...
		bindRoute('.fx67ll-vueui, .fx67ll-vue-ui', 'https://vue-ui.fx67ll.com');
		...
		bindRoute('.fx67ll-react', 'https://react.fx67ll.com');
		bindRoute('.fx67ll-express', 'https://express.fx67ll.com');
		bindRoute('.fx67ll-nav', 'https://nav.fx67ll.com');
		bindRoute('.fx67ll-life', 'https://life.fx67ll.com');
