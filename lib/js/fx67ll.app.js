...
(function (global) {
	...
	function initFaithCopy() {
		...
		// 原始记录见 fx67llBlog/2026/2026-08/2018-fx67ll-history.md，多行条目已合并为一行
		var copyList = [
			...
			'🙂😃😆😍😔😵‍💫🤡😥😢😭💀🥴',
			'当你感受不到自我价值时，你的内心会有一种空空洞洞的感觉，你会感到匮乏、自卑，只想拿外在的价值来填满这个洞，你会利用别人对你的肯定和赞赏来达到这个目的，你会以虚假的价值来填补这个洞。 -- 阿玛斯《内在的探索》',
			'我们带着一身的坑洞四处奔忙，却往往无法察觉到它们。我们通常只能意识到自己的欲望，我想要赞美、我想要成功、我想要这个人的爱、我想要这种或那种经验。欲望与需求一出现，便暗示着坑洞已经冒出来了… -- 阿玛斯《内在的探索》',
